        ...
        public void someAction() {
            ...
            while (true)
            {
                ...
                } else
                {
                    ...
                    System.out.println(String.format(SecondClass.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.substring(1, SecondClass.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.length()) + "%s", param));
                    break;
                }
            }
