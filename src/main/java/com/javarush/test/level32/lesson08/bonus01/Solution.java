...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class<? extends Item> returnType, Class<?> ... additionalInterfaces) {
        ...
        Object proxy = Proxy.newProxyInstance(returnType.getClassLoader(), interfaces, new ItemInvocationHandler());
        return (T)proxy;
    }
}
